            ...
            <form method="POST" action="{{ route('update-community-action', $community->id) }}">
                ...
                <div class="mt-4">
                    ...
                    <x-select name="betCreationPolicy" value="{{$community->betCreationPolicy}}">
                        ...
                        <option value="creators" @selected($community->betCreationPolicy === 'creators')>Creators only</option>
                        <option value="everyone" @selected($community->betCreationPolicy === 'everyone')>Everyone</option>
                    </x-select>
                </div>
